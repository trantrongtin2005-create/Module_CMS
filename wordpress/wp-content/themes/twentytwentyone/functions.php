...
/**
 * Custom Bootstrap-style comment
 */
function dan_custom_comment( $comment, $args, $depth ) {

	$GLOBALS['comment'] = $comment;
	?>

	<li <?php comment_class( 'media comment-box', $comment ); ?> id="comment-<?php comment_ID(); ?>">
		...
		<div class="media-body">
			...
			<div class="comment-actions">
				...
				<?php
				edit_comment_link(
					esc_html__( 'Edit', 'twentytwentyone' )
				);
				?>
